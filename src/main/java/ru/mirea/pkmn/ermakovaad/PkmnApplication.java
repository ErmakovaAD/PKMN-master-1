package ru.mirea.pkmn.ermakovaad;

import com.fasterxml.jackson.databind.JsonNode;
import ru.mirea.pkmn.*;
import ru.mirea.pkmn.ermakovaad.web.http.PkmnHttpClient;
import ru.mirea.pkmn.ermakovaad.web.jdbc.DatabaseServiceImpl;
...
public class PkmnApplication {
    public static void main(String[] args) throws IOException, SQLException {
        ...
        //Card card = databaseService.getCardFromDatabase("Aquapolis");
